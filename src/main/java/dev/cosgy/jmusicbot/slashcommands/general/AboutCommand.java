...
public class AboutCommand extends SlashCommand {
    ...
    protected void execute(SlashCommandEvent event) {
        ...
        String CosgyOwner = "SyntX is responsible for operation and development.";
        ...
        StringBuilder descr = new StringBuilder().append("Hello! I am **").append(event.getJDA().getSelfUser().getName()).append("**. ")
                .append(description).append(" uses [Commands Extension](https://github.com/JDA-Applications) by [" + JDAUtilitiesInfo.AUTHOR + "](https://github.com/JDA-Applications) (")
                .append(JDAUtilitiesInfo.VERSION).append(") and [JDA library](https://github.com/DV8FromTheWorld/JDA) (")
                .append(JDAInfo.VERSION).append(") and is owned by ")
                .append((IS_AUTHOR ? CosgyOwner : author)).append(".")
                .append(" For any questions about ").append(event.getJDA().getSelfUser().getName()).append(", please visit [SyntX Dev Official Channel](https://discord.gg/2DjsQ4xdd5).")
    ...
    protected void execute(CommandEvent event) {
        ...
        StringBuilder descr = new StringBuilder().append("Hello! I am **").append(event.getSelfUser().getName()).append("**. ")
                .append(description).append(" uses [Commands Extension](https://github.com/JDA-Applications) by " + JDAUtilitiesInfo.AUTHOR + " (")
                .append(JDAUtilitiesInfo.VERSION).append(") and [JDA library](https://github.com/DV8FromTheWorld/JDA) (")
                .append(JDAInfo.VERSION).append(") and is owned by ")
                .append((IS_AUTHOR ? CosgyOwner : author)).append(".")
                .append(" For any questions about ").append(event.getSelfUser().getName()).append(", please visit [SyntX Dev Official Channel](https://discord.gg/2DjsQ4xdd5).")
