...
public class HTTPUtil {
    ...
    public String request() {
        ...
        if (targetAddress == null || targetAddress.isEmpty()) throw new NullPointerException("URL is not set.");
        ...
        try {
            ...
            throw new NullPointerException("Invalid URL: " + e.getLocalizedMessage());
